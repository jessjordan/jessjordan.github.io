...
!function(e, t) {
    ...
    function f(e, t) {
        ...
        if (e !== u && t !== u || o.contains(r))
            return p = u, l = p.nodeName, "BODY" === l || "HTML" !== l && i(p.firstElementChild) !== p ? i(u) : u;
        var d = s(e);
    ...
    var s,
        ...
        Hn = (P = "carousel", H = "." + (j = "bs.carousel"), L = ".data-api", R = (k = e).fn[P], x = {
            ...
            return e.next = function() {
                ...
                if (t === U ? (n = z, i = J, r = F) : (n = Y, i = Z, r = K), l && k(l).hasClass(B))
                    this._isSliding = !1;
                    ...
                    if (k(this._element).hasClass(V)) {
                        ...
                        k(s).removeClass(B), k(l).addClass(B), this._isSliding = !1, k(this._element).trigger(u);
                    h && this.cycle()
                }
            }, t._jQueryInterface = function(e) {
                return this.each(function() {
                    ...
                    if (n || (n = new t(this, i), k(this).data(j, n)), "number" == typeof e)
                        n.to(e);
        ...
        xn = (Zt = "modal", $t = "." + (Gt = "bs.modal"), Xt = (Jt = e).fn[Zt], te = {
            ...
            return e.toggle = function(t) {
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    }), n && kn.reflow(this._backdrop), Jt(this._backdrop).addClass(ae), !t)
                        return;
                    if (!n)
                        return void t();
            ...
            return e.enable = function() {
                ...
                if (this._isEnabled)
                    if (t) {
                        ...
                        if (ge(this.getTipElement()).hasClass(we))
                ...
                var t = this;
                if ("none" === ge(this.element).css("display"))
...
!function(e) {
    ...
    v.prototype = {
        ...
        if ("string" == typeof n)
            ...
            n = e.extend(!0, {}, n), C ? i.data("magnificPopup", n) : i[0].magnificPopup = n, t.addGroup(i, n);
        return i
    };
    var T,
        E,
...
!function(t, e) {
        ...
        f = {
            f: i ? Object.defineProperty : function(n, i, r) {
                if (e(n), i = function(e, n) {
                    ...
                    var i,
                        r;
                    if (n && "function" == typeof (i = e.toString) && !t(r = i.call(e)))
                        return r;
                    if ("function" == typeof (i = e.valueOf) && !t(r = i.call(e)))
                        return r;
                    if (!n && "function" == typeof (i = e.toString) && !t(r = i.call(e)))
                        return r;
    ...
    var V,
        ...
        lt = function() {
            var t,
                e = l("iframe"),
                n = et.length;
            for (e.style.display = "none", ot.appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), lt = t.F; n--;)
                delete lt[at][et[n]];
            return lt()
        },
    ...
    var pt = function(t) {
        ...
        Ot = function(t, e, n, i, r, o, s) {
            ...
            if (_ && (f = mt(_.call(new t))) !== Object.prototype && f.next && (dt(f, b, !0), "function" != typeof f[gt] && v(f, gt, wt)), y && E && E.name !== St && (m = !0, w = function() {
                return E.call(this)
            }), (Et || m || !g[gt]) && v(g, gt, w), D[e] = w, D[b] = wt, r)
                if (u = {
                    values: y ? w : p(St),
                    keys: o ? w : p("keys"),
                    entries: O
    ...
    for (var _t = _("iterator"), kt = _("toStringTag"), xt = D.Array, Lt = {
        ...
        var Tt,
            ...
            jt = s[zt],
            Dt = jt && jt.prototype;
        if (Dt && (Dt[_t] || v(Dt, _t, xt), Dt[kt] || v(Dt, kt, zt), D[zt] = xt, Ct))
            for (Tt in Ot)
    ...
    var Yt = function(t, n, i, r) {
        ...
        Vt = E.getIteratorMethod = function(t) {
            if (void 0 != t)
                return t[Bt] || t["@@iterator"] || D[(e = t, void 0 === e ? "Undefined" : null === e ? "Null" : "string" == typeof (i = function(t, e) {
                        try {
                            return t[e]
                        } catch (t) {}
    ...
    F(F.S + F.F * !function(t, e) {
        ...
        from: function(t) {
            ...
            if (u && (l = W(l, a > 2 ? arguments[2] : void 0, 2)), void 0 != f && (c != Array || (void 0 === (o = f) || D.Array !== o && Xt[Nt] !== o)))
                for (r = f.call(s), n = new c; !(i = r.next()).done; h++)
                    Rt(n, h, u ? Yt(r, l, [i.value, h], !0) : i.value);
            else
                for (n = new c(e = U(s.length)); e > h; h++)
    ...
    function fe(t, e, n) {
        ...
        function y() {
            ...
            if (i = arguments, r = this, a = n, o) {
                if (void 0 === c)
                    return l = t = a, c = setTimeout(p, e), u ? d(t) : s;
                if (h)
                    return c = setTimeout(p, e), d(a)
            }
    ...
    function ve(t) {
        if ("number" == typeof t)
            return t;
        if ("symbol" == typeof (e = t) || (n = e) && "object" == typeof n && ae.call(e) == Zt)
            return Qt;
        var e,
            n;
        if (de(t)) {
    ...
    var De = function(t, e) {
        ...
        Ye = function(t, e, n) {
            if (this.activeObservations_ = [], this.observations_ = new be, "function" != typeof t)
